...
<xsl:template name="cell" match="state/fact">
  ...
  <xsl:choose>
    <xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='1']"> 1 </xsl:when>
  	...
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='9']"> 9 </xsl:when>  	
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='10']"> 10 </xsl:when>  	
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='11']"> 11 </xsl:when>  	
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='12']"> 12 </xsl:when>  	
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='13']"> 13 </xsl:when>  	
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='14']"> 14 </xsl:when>  	
  	<xsl:when test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='15']"> 15 </xsl:when>  	
  </xsl:choose>
