...
/**
 * Unit tests for the BaseCryptography class, which implements a wrapper for
 * the use of asymmetric public/private key cryptography for use in GGP.
 * 
 * @author Sam
 */
public class Test_InfoResponse extends TestCase
{
  public void testFormingInfoResponse()
  {
    ...
    assertEquals(response.toSymbol().toString(),
                 "( ( name PlayerName ) ( status available ) )");
  }
