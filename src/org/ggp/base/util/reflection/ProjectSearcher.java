...
public class ProjectSearcher
{
  ...
  public static class LoadedClasses<T>
  {
    ...
    private LoadedClasses(Class<T> interfaceClass)
    {
      ...
      this.allClasses = ImmutableSet.copyOf(REFLECTIONS
          .getSubTypesOf(interfaceClass));
      this.concreteClasses = ImmutableSet.copyOf(Sets
          .filter(allClasses, IS_CONCRETE_CLASS));
    }
    ...
    {
      return Objects.toStringHelper(this).add("allClasses", allClasses)
          .add("interfaceClass", interfaceClass)
          .add("concreteClasses", concreteClasses).toString();
    }
  }
}
