...
public class Test_Http extends TestCase
{
  ...
  public void testPathologicalEchos() throws IOException
  {
    ...
    doSimpleEchoCheck(testPair,
                      "123 456 ^&!*! // 2198725 !@#$%^&*() DATA",
                      "SamplePlayer");
    doSimpleEchoCheck(testPair,
                      "abcdefgijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",
                      "SamplePlayer");
  ...
  public void testGenericPOSTs() throws IOException
  {
    ...
    doClientEchoCheckOverPOST(testPair,
                              ...
                              "Accept: text/delim\nSender: GAMESERVER");
    doClientEchoCheckOverPOST(testPair,
                              "1234567890abcdefgijklmnopqrstuvwxyz!@#$%^&*()1234567890",
                              "");
  }
  ...
  private void doSimpleEchoCheck(SocketPair p, String data, String playerName)
      throws IOException
  {
  ...
  private void doClientEchoCheckOverPOST(SocketPair p,
                                         String data,
  ...
  private void doClientEchoCheckOverGET(SocketPair p,
                                        String data,
                                        String headers) throws IOException
  {
  ...
  private void writeClientPostHTTP(Socket writeOutTo,
                                   String headers,
  ...
  private void writeClientGetHTTP(Socket writeOutTo,
                                  String headers,
                                  String data) throws IOException
  {
    BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(writeOutTo.getOutputStream()));
