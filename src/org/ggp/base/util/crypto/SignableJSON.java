...
public class SignableJSON
{
  ...
  public static void signJSON(JSONObject theJSON, String thePK, String theSK)
      throws JSONException
  {
    ...
    String theSignature = BaseCryptography.signData(theSK, CanonicalJSON
        .getCanonicalForm(theJSON, CanonicalizationStrategy.SIMPLE));
    theJSON
  ...
  public static boolean verifySignedJSON(JSONObject theJSON)
      throws JSONException
  {
    if (!theJSON.has("matchHostPK") || !theJSON.has("matchHostSignature"))
    ...
    try
    {
      return BaseCryptography
          .verifySignature(thePK, theSignature, CanonicalJSON
              .getCanonicalForm(tempObject, CanonicalizationStrategy.SIMPLE));
    }
