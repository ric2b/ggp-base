...
/**
 * Unit tests for the SignableJSON class, which provides an easy way for code
 * to sign JSON objects using PK/SK pairs, and check whether a particular
 * object has been signed.
 * 
 * @author Sam
 */
public class Test_SignableJSON extends TestCase
{
  public void testSimpleSigning() throws JSONException
  {
    ...
    JSONObject x2 = new JSONObject(x.toString().replace(",", ", ")
        .replace("{", "{ ").replace("}", "} "));
