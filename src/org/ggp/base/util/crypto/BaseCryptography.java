...
public class BaseCryptography
{
  public static void main(String args[])
  {
    ...
    System.out.println("{\"PK\":\"" + k.thePublicKey + "\", \"SK\":\"" +
                       k.thePrivateKey + "\"}");
  }
  ...
  public static boolean verifySignature(String thePublicKey,
                                        String theSignature,
                                        String theData)
  ...
  {
    if (!thePK.startsWith(theCryptographyPrefix))
      return null;
  ...
  {
    if (!theSK.startsWith(theCryptographyPrefix))
      return null;
  ...
  {
    if (!theSig.startsWith(theCryptographyPrefix))
      return null;
