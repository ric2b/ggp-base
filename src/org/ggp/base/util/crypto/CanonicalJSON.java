...
{
  /*
   * Right now we only support one canonicalization strategy, which is the
   * SIMPLE approach. In the future, we may need to make breaking changes to
   * the canonicalization strategy, to support unforeseen situations (e.g. edge
   * cases the current canonicalization strategy doesn't handle properly).
