...
public final class Substituter
{
  ...
  private static GdlConstant substituteConstant(GdlConstant constant,
                                                Substitution theta)
  {
    return constant;
  }

  private static GdlDistinct substituteDistinct(GdlDistinct distinct,
                                                Substitution theta)
  {
  ...
  private static GdlRelation substituteRelation(GdlRelation relation,
                                                Substitution theta)
  {
  ...
  private static GdlTerm substituteVariable(GdlVariable variable,
                                            Substitution theta)
  {
