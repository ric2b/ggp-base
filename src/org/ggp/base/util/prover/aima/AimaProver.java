...
public final class AimaProver extends Prover
{
  ...
  private Set<GdlSentence> ask(GdlSentence query,
  ...
  private void ask(LinkedList<GdlLiteral> goals,
  ...
  private void askDistinct(GdlDistinct distinct,
                           LinkedList<GdlLiteral> goals,
                           KnowledgeBase context,
                           Substitution theta,
                           ProverCache cache,
                           VariableRenamer renamer,
  ...
  private void askNot(GdlNot not,
                      LinkedList<GdlLiteral> goals,
                      KnowledgeBase context,
                      Substitution theta,
                      ProverCache cache,
  ...
  private void askSentence(GdlSentence sentence,
                           LinkedList<GdlLiteral> goals,
                           KnowledgeBase context,
                           Substitution theta,
                           ProverCache cache,
