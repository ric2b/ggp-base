...
/**
 * Contains a set of GdlSentences arranged by SentenceForm and the associated
 * FunctionInfo for each SentenceForm. The FunctionInfos are continually and
 * automatically maintained as sentences are added to the set. Note that this
...
public class GdlSentenceSet
{
  ...
  /**
   * Returns an unmodifiable view of the sentences in this set. Note that this
   * view may change if the collection is concurrently modified.
   */
