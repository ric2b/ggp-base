 ...
 * query a repository to get a list of available games (by key), and given a
 * key, you can look up the associated Game object. All queries to a game
 * repository are cached, and the caching is handled in this abstract base
 * class. Concrete subclasses will implement the actual behavior required for
 * fetching games from the underlying repositories.
 * 
 * @author Sam
 */
