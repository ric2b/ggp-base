 ...
 * <p>
 * The list of roles defined in a game description can be extracted using the
 * {@link #computeRoles(List)} method.
 */
...
public class Role implements Serializable
{
   ...
   * <p>
   * Order matters, because a joint move is defined as an ordered list of
   * moves, in which the order determines which player took which of the moves.
