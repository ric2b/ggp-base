...
public class TestPropnetStateMachine extends StateMachine {
    ...
    public void recreate(PolymorphicComponentFactory factory)
    {
		...
		basePropositionTransitions = new PolymorphicComponent[propNet.getBasePropositionsArray().length];
		int index = 0;
	...
	throws MoveDefinitionException
	{
		...
		try
		{
			...
			PolymorphicProposition[] legalProps = propNet.getLegalPropositions().get(role);
