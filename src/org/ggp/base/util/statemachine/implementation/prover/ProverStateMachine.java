...
public class ProverStateMachine extends StateMachine
{
  ...
  private MachineState computeInitialState()
  {
    Set<GdlSentence> results = prover
        .askAll(ProverQueryBuilder.getInitQuery(), new HashSet<GdlSentence>());
  ...
  {
    Set<GdlSentence> results = prover.askAll(ProverQueryBuilder
        .getLegalQuery(role), ProverQueryBuilder.getContext(state));
  ...
  {
    return prover.prove(ProverQueryBuilder.getTerminalQuery(),
