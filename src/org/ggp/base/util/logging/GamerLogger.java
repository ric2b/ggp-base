 ...
 * the logger is called. TODO: More details about specific use examples.
 * 
...
public class GamerLogger
{
                               ...
                               int logLevel)
  {
    ...
    try
    {
      String logMessage = logFormat(logLevel,
                                    ordinaryOutput == System.err,
                                    message);
      ...
      if (theRandom.nextInt(1000) == 0)
      {
        ...
        if (new File(myFilename).length() > maximumLogfileSize)
        {
          ...
          logLevel = 9;
          logMessage = logFormat(logLevel,
                                 ordinaryOutput == System.err,
                                 "File too long; stopping all writes to this file.");
        }
      }
  ...
  {
    String logMessage = "LOG " + System.currentTimeMillis() + " [L" +
                        logLevel + "]: " + (isError ? "<ERR> " : "") + message;
