...
/**
 * Unit tests for the GdlRenderer class, which provides a way to render Gdl
 * objects as Strings.
 * 
 * @author Sam
 */
...
{
  /**
   * One important property for GdlRenderer is that it should generate an
   * identical rendering as if you had called the toString() method on a Gdl
   * object.
   */
