...
/**
 * A renderer for Gdl objects. On its own, this class renders a Gdl object in
 * the way you'd expect. It can be subclassed to override particular parts of
 * the rendering scheme; for example, to render GdlConstants scrambled via a
 * mapping. TODO(schreib): Would it ever make sense for this to replace the
 * regular toString methods in the Gdl objects? TODO(schreib): What is the
 * relationship between this and the GdlVisitor framework that Alex put
 * together? Can they be combined?
 * 
...
public class GdlRenderer
{
  ...
  protected String renderSentence(GdlSentence sentence)
  {
    ...
    {
      throw new RuntimeException("Unexpected GdlSentence type " +
                                 sentence.getClass());
    }
  }
  ...
  protected String renderLiteral(GdlLiteral literal)
  {
    ...
    {
      throw new RuntimeException("Unexpected GdlLiteral type " +
                                 literal.getClass());
    }
  }
  ...
  {
    return "( distinct " + renderTerm(distinct.getArg1()) + " " +
           renderTerm(distinct.getArg2()) + " )";
  }
