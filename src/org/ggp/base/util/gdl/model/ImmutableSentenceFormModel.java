...
public class ImmutableSentenceFormModel implements SentenceFormModel
{
  ...
  {
    Preconditions.checkArgument(sentenceForms
        .containsAll(independentSentenceForms));
    Preconditions.checkArgument(independentSentenceForms
        .containsAll(constantSentenceForms));
    Preconditions.checkArgument(sentenceForms.containsAll(dependencyGraph
        .keySet()));
    Preconditions.checkArgument(sentenceForms.containsAll(dependencyGraph
        .values()));
    Preconditions
        .checkArgument(sentenceForms.containsAll(rulesByForm.keySet()));
    Preconditions.checkArgument(sentenceForms.containsAll(trueSentencesByForm
        .keySet()));
  ...
  /**
   * Returns an ImmutableSentenceFormModel with the same contents as the given
   * SentenceFormModel. May not actually create a copy if the input is
   * immutable.
   */
  public static ImmutableSentenceFormModel copyOf(SentenceFormModel other)
  {
    ...
    ImmutableSetMultimap.Builder<SentenceForm, GdlRule> rulesByForm = ImmutableSetMultimap
        .builder();
    ImmutableSetMultimap.Builder<SentenceForm, GdlSentence> trueSentencesByForm = ImmutableSetMultimap
        .builder();
    ...
    return new ImmutableSentenceFormModel(ImmutableList.copyOf(other
                                              .getDescription()),
                                          ...
                                          ImmutableSet.copyOf(other
                                              .getIndependentSentenceForms()),
                                          ImmutableSetMultimap.copyOf(other
                                              .getDependencyGraph()),
                                          rulesByForm.build(),
