...
public class AssignmentFunction
{
  ...
  public static AssignmentFunction create(GdlRelation conjunct,
                                          FunctionInfo functionInfo,
                                          GdlVariable rightmostVar,
                                          List<GdlVariable> varOrder,
                                          Map<GdlVariable, GdlConstant> preassignment)
  {
    ...
    Map<ImmutableList<GdlConstant>, GdlConstant> function = functionInfo
        .getValueMap(varIndex);
    ...
    return new AssignmentFunction(ImmutableList.copyOf(internalFunctions),
                                  querySize,
