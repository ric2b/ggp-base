...
public class FunctionInfoImpl implements FunctionInfo
{
   ...
   * variables in the sentence that can be produced functionally. Note the
   * corner case: If a variable appears twice in a sentence, it CANNOT be
  ...
  public Set<GdlVariable> getProducibleVars(GdlSentence sentence)
  {
    ...
    for (int i = 0; i < tuple.size(); i++)
    {
      ...
      if (term instanceof GdlVariable && !multipleVars.contains(term))
      {
