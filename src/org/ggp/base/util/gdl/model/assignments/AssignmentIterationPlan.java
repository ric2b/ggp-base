...
public class AssignmentIterationPlan
{
  ...
  public AssignmentIterationPlan(ImmutableList<GdlVariable> varsToAssign,
  ...
  private static final AssignmentIterationPlan EMPTY_ITERATION_PLAN = new AssignmentIterationPlan(null,
                                                                                                  null,
                                                                                                  null,
                                                                                                  null,
                                                                                                  null,
                                               ...
                                               boolean allDone)
  {
    ...
    return new AssignmentIterationPlan(ImmutableList.copyOf(varsToAssign),
                                       ...
                                       ImmutableList
                                           .copyOf(indicesToChangeWhenNull),
                                       ImmutableList.copyOf(distincts),
                                       fromNullableList(varsToChangePerDistinct),
                                       fromNullableList(valuesToCompute),
                                       ImmutableList
                                           .copyOf(sourceDefiningSlot),
                                       ImmutableList.copyOf(valuesToIterate),
                                       ImmutableList
                                           .copyOf(varsChosenBySource),
                                       ImmutableList
                                           .copyOf(putDontCheckBySource),
                                       empty,
                                       allDone);
  }

  private static <T> ImmutableMap<Integer, T> fromNullableList(List<T> nullableList)
  {
