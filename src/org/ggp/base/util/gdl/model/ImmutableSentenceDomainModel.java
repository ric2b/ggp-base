...
public class ImmutableSentenceDomainModel extends AbstractSentenceDomainModel
{
  ...
  private ImmutableSentenceDomainModel(ImmutableSentenceFormModel formModel,
  ...
  public static ImmutableSentenceDomainModel copyUsingCartesianDomains(SentenceDomainModel otherModel)
  {
    ...
    ImmutableMap.Builder<SentenceForm, SentenceFormDomain> domains = ImmutableMap
        .builder();
    for (SentenceForm form : otherModel.getSentenceForms())
    {
      ...
      domains.put(form,
                  CartesianSentenceFormDomain.create(form, domainsForSlots));
    }
    return new ImmutableSentenceDomainModel(ImmutableSentenceFormModel.copyOf(otherModel),
                                            domains.build());
  }
