...
public class SentenceDomainModels
{
  public static enum VarDomainOpts {
    INCLUDE_HEAD, BODY_ONLY
  }

  public static Map<GdlVariable, Set<GdlConstant>> getVarDomains(GdlRule rule,
                                                                 ...
                                                                 VarDomainOpts includeHead)
  {
    ...
    Multimap<GdlVariable, Set<GdlConstant>> varDomainsByVar = ArrayListMultimap
        .create();
  ...
  public static Iterable<GdlLiteral> getSentences(GdlRule rule,
                                                  VarDomainOpts includeHead)
  {
  ...
  {
    return ImmutableMap
        .copyOf(Maps.transformValues(varDomainsByVar.asMap(),
  ...
  private static <T> Set<T> intersectSets(Collection<Set<T>> input)
  {
    if (input.isEmpty())
    {
