 ...
 * {@link SentenceDomainModelFactory#createWithCartesianDomains(java.util.List)}
 * .
 */
public interface SentenceDomainModel extends SentenceFormModel
{
  /**
   * Gets the domain of a particular sentence form, which has information about
   * which particular sentences of the given sentence form are possible.
   */
