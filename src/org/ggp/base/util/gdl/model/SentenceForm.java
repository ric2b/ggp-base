...
public interface SentenceForm
{
  ...
  /**
   * Returns the number of constants and/or variables that a sentence of this
   * form contains.
   */
  int getTupleSize();

  /**
   * Given a list of GdlConstants and/or GdlVariables in the order they would
   * appear in a sentence of this sentence form, returns that sentence. For the
   * opposite operation (getting a tuple from a sentence), see
   * {@link GdlUtils#getTupleFromSentence(GdlSentence)} and
