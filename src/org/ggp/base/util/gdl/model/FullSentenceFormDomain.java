...
public class FullSentenceFormDomain implements SentenceFormDomain
{
  ...
  public FullSentenceFormDomain(SentenceForm form,
  ...
  public static FullSentenceFormDomain create(SentenceForm form,
                                              Collection<GdlSentence> domain)
  {
    List<ImmutableSet.Builder<GdlConstant>> domainsForSlotsBuilder = Lists
        .newArrayList();
    ...
    ImmutableList.Builder<ImmutableSet<GdlConstant>> domainsForSlots = ImmutableList
        .builder();
    for (ImmutableSet.Builder<GdlConstant> builder : domainsForSlotsBuilder)
    {
      domainsForSlots.add(builder.build());
    }
    return new FullSentenceFormDomain(form,
                                      ImmutableList.copyOf(domain),
