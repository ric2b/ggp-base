...
/**
 * A ConstantChecker provides information about which sentences are true for
 * the constant sentence forms in a game. These can be computed once at the
 * beginning of a match, to avoid redundant computations. The preferred way to
 * create a ConstantChecker is with
...
{
  /**
   * Returns true iff the sentence is of a constant form included in this
   * ConstantChecker.
   */
  boolean hasConstantForm(GdlSentence sentence);

  /**
   * Returns true iff the given sentence form is constant and is included in
  ...
  /**
   * Returns the set of all constant sentence forms included in this
   * ConstantChecker.
   */
  Set<SentenceForm> getConstantSentenceForms();

  /**
   * Returns true iff the given sentence is of a constant sentence form and is
   * always true.
   */
