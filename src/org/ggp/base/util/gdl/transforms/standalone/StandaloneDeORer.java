...
/**
 * The standalone version of DeORer can be run as its own program. It takes a
 * .kif file as input and generates a new .kif file with the modified output.
 * The new filename is (original name)_DEORED.kif. The new file is not intended
 * to be particularly legible; it is intended mainly for use by other programs.
 * 
 * @author Alex Landau
 */
