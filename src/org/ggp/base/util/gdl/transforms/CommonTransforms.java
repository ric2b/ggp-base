...
public class CommonTransforms
{
  ...
  public static GdlRule replaceVariable(GdlRule rule,
                                        GdlVariable toSubstitute,
                                        GdlTerm theReplacement)
  {
    return (GdlRule)replaceVariableInternal(rule, toSubstitute, theReplacement);
  }

  public static GdlLiteral replaceVariable(GdlLiteral literal,
                                           GdlVariable toSubstitute,
                                           GdlTerm theReplacement)
  {
    return (GdlLiteral)replaceVariableInternal(literal,
                                               toSubstitute,
                                               theReplacement);
  }

  public static GdlSentence replaceVariable(GdlSentence sentence,
                                            GdlVariable toSubstitute,
                                            GdlTerm theReplacement)
  {
    return (GdlSentence)replaceVariableInternal(sentence,
                                                toSubstitute,
                                                theReplacement);
  }

  private static Gdl replaceVariableInternal(Gdl gdl,
                                             GdlVariable toSubstitute,
                                             GdlTerm theReplacement)
  {
    ...
    {
      return GdlPool
          .getDistinct((GdlTerm)replaceVariableInternal(((GdlDistinct)gdl)
                           .getArg1(), toSubstitute, theReplacement),
                       (GdlTerm)replaceVariableInternal(((GdlDistinct)gdl)
                           .getArg2(), toSubstitute, theReplacement));
    }
    else if (gdl instanceof GdlNot)
    {
      return GdlPool.getNot((GdlLiteral)replaceVariableInternal(((GdlNot)gdl)
          .getBody(), toSubstitute, theReplacement));
    }
    ...
    else if (gdl instanceof GdlRule)
    {
      ...
      return GdlPool.getRule((GdlSentence)replaceVariableInternal(rule
                                 .getHead(), toSubstitute, theReplacement),
                             rval);
    }
                                              ...
                                              Map<GdlVariable, ? extends GdlTerm> assignment)
  {
    ...
    else
    {
      throw new RuntimeException("Unforeseen Gdl subtype " +
                                 gdl.getClass().getSimpleName());
    }
  }

  public static GdlRelation replaceHead(GdlRelation sentence,
                                        GdlConstant newHead)
  {
