...
public class Relationizer
{
   ...
   * replaces them with these simpler forms. Some games have been written such
   * that unchanging facts of the game are listed as base propositions. Often,
   * this is so the fact can be accessed by a visualization. Gamers usually
        ...
        if (rules.size() == 1)
        {
          ...
          if (rule.arity() == 1)
          {
            ...
            if (literal instanceof GdlRelation)
            {
              ...
              SentenceForm trueForm = nextForm.withName(GdlPool
                  .getConstant("true"));
                                                     ...
                                                     SentenceForm trueForm)
  {
    ...
    {
      throw new RuntimeException("Unanticipated GDL literal type " +
                                 literal.getClass() +
                                 " encountered in Relationizer");
    }
  }
}
