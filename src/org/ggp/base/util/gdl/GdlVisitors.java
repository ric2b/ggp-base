...
{
  /**
   * Visits the given Gdl object and any contained Gdl objects within with the
   * given GdlVisitor. For example, when called on a GdlRule, the visitor's
   * visitConstant function is called once for every constant anywhere in the
  ...
  public static void visitAll(Collection<? extends Gdl> collection,
                              GdlVisitor visitor)
  {
