...
public class CloseableTabs
{
  ...
  public static void addClosableTab(JTabbedPane tabPane,
                                    JComponent tabContent,
                                    String tabName,
                                    AbstractAction closeAction)
  {
    ...
    BufferedImage img = new BufferedImage(CLOSE_ICON_SIZE,
                                          CLOSE_ICON_SIZE,
    ...
    tabTopPanel.add(new JLabel(tabName),
