...
public class PlayerSelector
{
  ...
  class PlayerPresenceLabel extends JLabel implements ListCellRenderer<String>
  {
                                                  ...
                                                  boolean cellHasFocus)
    {
      ...
      PlayerPresence presence = thePresenceManager.getPresence(value
          .toString());
      ...
      BufferedImage img = new BufferedImage(iconSize,
                                            iconSize,
  ...
  class PlayerSelectorList extends JList<String> implements Observer
  {
    ...
    {
      setListData(thePresenceManager.getSortedPlayerNames()
