...
public abstract class Analyser
{
  ...
  public abstract void accrueInterimStateSample(ForwardDeadReckonInternalMachineState state,
                                                int choosingRoleIndex);

  //	Accrue a rollout sample (terminal state from a rollout)
  public abstract void accrueTerminalStateSample(ForwardDeadReckonInternalMachineState state,
                                                 double[] roleScores);
