...
/**
 * HumanGamer is a simple apparatus for letting a human control a player, by
 * manually choosing moves in the player's detail panel. This player will not
 * work without a human actually interacting with the detail panel. This player
 * has a very simplistic user interface; if you actually want to play as a
 * human, you're probably better off using the purpose-built Kiosk app.
 */
public final class HumanGamer extends StateMachineGamer
{
  ...
  /**
   * Selects the default move as the first legal move, and then waits while the
   * Human sets their move. This is done via the HumanDetailPanel.
   */
  @Override
  public synchronized Move stateMachineSelectMove(long timeout)
