 ...
 * it identifies, regardless of the state of the game. For your first players,
 * you should extend the class SampleGamer The only function that you are
 * required to override is : public Move stateMachineSelectMove(long timeout)
 */
