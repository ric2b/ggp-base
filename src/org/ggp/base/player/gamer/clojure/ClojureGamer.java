 ...
 * rest of the Java framework. In order to do this, do the following: 1) Create
 * a subclass of ClojureGamer that overrides getClojureGamerFile() and
 * getClojureGamerName() to indicate where the Clojure source code file is.
 * This is the Java stub that refers to the real Clojure gamer class. 2) Create
 * the Clojure source code file, in the /src_clj/ directory in the root
 * directory for this project. Make sure that the stub points to this class,
 * and that the Clojure class is a valid subclass of Gamer. For examples where
 * this has already been done, see @ClojureLegalGamerStub, which is implemented
 * in Clojure and hook into the Java framework using the ClojureGamer stub.
 * 
...
public abstract class ClojureGamer extends Gamer
{
    ...
    if (theClojureGamer == null)
    {
      ...
      catch (Exception e)
      {
        GamerLogger.logError("GamePlayer",
                             "Caught exception in Clojure initialization:");
  ...
  @Override
  public final void preview(Game game, long timeout)
      throws GamePreviewException
  {
    ...
    catch (GamePreviewException e)
    {
      GamerLogger
          .logError("GamePlayer",
                    "Caught exception in Clojure stateMachineMetaGame:");
      GamerLogger.logStackTrace("GamePlayer", e);
    }
  }
  ...
  public final GdlTerm selectMove(long timeout) throws MoveSelectionException
  {
    ...
    catch (MoveSelectionException e)
    {
      GamerLogger
          .logError("GamePlayer",
                    "Caught exception in Clojure stateMachineSelectMove:");
      GamerLogger.logStackTrace("GamePlayer", e);
      return null;
    }
  }
  ...
  public final void stop()
  {
    ...
    {
      GamerLogger.logError("GamePlayer",
                           "Caught exception in Clojure stateMachineStop:");
      GamerLogger.logStackTrace("GamePlayer", e);
    }
  }
  ...
  public final void abort()
  {
    ...
    {
      GamerLogger.logError("GamePlayer",
                           "Caught exception in Clojure stateMachineAbort:");
      GamerLogger.logStackTrace("GamePlayer", e);
    }
  }
