...
public class ProxyMessage implements Serializable
{
  ...
  public static ProxyMessage readFrom(BufferedReader theInput)
      throws SocketException
  {
    ...
    catch (SocketException se)
    {
      GamerLogger
          .log("Proxy",
               "[ProxyMessage Reader] Socket closed: stopping read operation.");
      throw se;
    }
    catch (Exception e)
    {
      ...
      GamerLogger
          .logError("Proxy",
                    "[ProxyMessage Reader] Could not digest message. Emptying stream.");
      try
      {
