...
public class BreakthroughHolesCanvas extends GameCanvas_Chessboard
{
  ...
  {
    return "Breakthrough (Holes)";
  }

  protected String getGameKey()
  {
    return "breakthroughHoles";
  }

  @Override
  protected Set<String> getFactsAboutCell(int xCell, int yCell)
  {
    Set<String> theFacts = gameStateHasFactsMatching("\\( cellHolds " + xCell +
                                                     " " + yCell + " (.*) \\)");
    theFacts.addAll(gameStateHasFactsMatching("\\( cellOffLimits " + xCell +
                                              " " + yCell + " \\)"));
    return theFacts;
  }
