...
public class CheckersTinyCanvas extends GameCanvas_Chessboard
{
  ...
  protected Set<String> getLegalMovesForCell(int xCell, int yCell)
  {
    ...
    Set<String> theMoves = gameStateHasLegalMovesMatching("\\( move .. " +
                                                          xLetter + " " +
                                                          yCell + " (.*) \\)");
    theMoves.addAll(gameStateHasLegalMovesMatching("\\( doublejump .. " +
                                                   xLetter + " " + yCell +
                                                   " (.*) \\)"));
    theMoves.addAll(gameStateHasLegalMovesMatching("\\( triplejump .. " +
                                                   xLetter + " " + yCell +
                                                   " (.*) \\)"));
    return theMoves;
  }
