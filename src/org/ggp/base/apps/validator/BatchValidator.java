...
/**
 * BatchValidator does game validation on all of the games in a given game
 * repository. This allows you to quickly determine which games need to be
 * repaired, given a large existing game repository with games of varying
 * quality.
 * 
 * @author schreib
 */
public final class BatchValidator
{
  public static void main(String[] args)
  {
    ...
    {
      if (gameKey.contains("amazons") || gameKey.contains("knightazons") ||
          gameKey.contains("factoringImpossibleTurtleBrain") ||
          gameKey.contains("quad") || gameKey.contains("blokbox") ||
          gameKey.contains("othello"))
        continue;
