...
public final class Validator extends JPanel implements ActionListener
{
  ...
  public Validator()
  {
    ...
    sourcePanel.add(new JLabel("Repository:"),
                    new GridBagConstraints(0,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(gameSelector.getRepositoryList(),
                    new GridBagConstraints(1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(new JLabel("Game:"),
                    new GridBagConstraints(0,
                                           nRowCount,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(gameSelector.getGameList(),
                    new GridBagConstraints(1,
                                           nRowCount++,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(new JSeparator(),
                    new GridBagConstraints(1,
                                           nRowCount++,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(new JLabel("Step Limit:"),
                    new GridBagConstraints(0,
                                           nRowCount,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(maxDepthTextField,
                    new GridBagConstraints(1,
                                           nRowCount++,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(new JLabel("Simulations:"),
                    new GridBagConstraints(0,
                                           nRowCount,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(simulationsTextField,
                    new GridBagConstraints(1,
                                           nRowCount++,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(new JLabel("Base Sim ms:"),
                    new GridBagConstraints(0,
                                           nRowCount,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(millisToSimulateField,
                    new GridBagConstraints(1,
                                           nRowCount++,
                                           1,
                                           1,
                                           ...
                                           5,
                                           5));
    sourcePanel.add(validateButton,
                    new GridBagConstraints(1,
                                           nRowCount++,
                                           1,
                                           1,
    ...
    simulationsPanel.add(simulationsTabbedPane,
                         new GridBagConstraints(0,
                                                0,
                                                1,
                                                1,
    ...
    this.add(sourcePanel, new GridBagConstraints(0,
                                                 0,
                                                 1,
                                                 1,
                                                 0.0,
