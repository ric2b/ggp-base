...
/**
 * This is a simple tabular detail panel that shows the number of available
 * moves, the time it took to select a move, and the move that was selected.
 */
...
public class SimpleDetailPanel extends DetailPanel
{
  ...
  public SimpleDetailPanel()
  {
    ...
    this.add(new JScrollPane(moveTable,
