	...
	public static void main(String[] args) throws IOException, InstantiationException, IllegalAccessException
	{
		...
		for(String arg : args)
		{
			if ( arg.startsWith("-"))
			{
			    ...
			    default:
			    	syntaxError = true;
			    	System.out.println("Valid parameters are -port:<portnum> -threads:<#rollout_threads> -tableSize<size in entries>");
			    	break;
				}
			}
			else
			{
				syntaxError = true;
				System.out.println("Arguments must begin with a '-': valid parameters are -port:<portnum> -threads:<#rollout_threads> -tableSize<size in entries>");
			}
		}
