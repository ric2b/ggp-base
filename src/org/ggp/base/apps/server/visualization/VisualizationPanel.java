...
public final class VisualizationPanel extends JPanel implements Observer
{
  ...
  public VisualizationPanel(Game theGame)
  {
    ...
    this.add(tabs, new GridBagConstraints(0,
                                          0,
                                          1,
                                          1,
                                          1.0,
                                          ...
                                          5,
                                          5));
    this.add(timerBar, new GridBagConstraints(0,
                                              1,
                                              1,
                                              1,
                                              1.0,
    ...
    public void run()
    {
      ...
      if (newPanel != null)
      {
        ...
        synchronized (tabLock)
        {
          ...
          {
            System.err
                .println("Adding rendered visualization panel failed for: " +
                         theGame.getKey());
          }
        }
      }
  ...
  public static void main(String args[])
  {
    ...
    Game theGame = GameRepository.getDefaultRepository()
