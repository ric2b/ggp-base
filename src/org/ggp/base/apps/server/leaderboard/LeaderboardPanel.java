...
public final class LeaderboardPanel extends JPanel implements Observer
{
  ...
  public LeaderboardPanel()
  {
    ...
    sorter.setSortKeys(Arrays
        .asList(new SortKey[] {new SortKey(1, SortOrder.DESCENDING)}));
    leaderTable.setRowSorter(sorter);

    add(new JLabelBold("Leaderboard"), BorderLayout.NORTH);
    add(new JScrollPane(leaderTable,
  ...
  public void observe(Event event)
  {
    ...
    {
      model.addRow(new Object[] {playerToAdd,
          goals.get(players.indexOf(playerToAdd)),
          errors.get(players.indexOf(playerToAdd))});
    }
    sorter.sort();
  }
