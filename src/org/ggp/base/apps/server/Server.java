...
public final class Server extends JPanel implements ActionListener
{
  ...
  public Server()
  {
    ...
    int nRowCount = 0;
    gamePanel.add(new JLabelBold("Match Setup"),
                  new GridBagConstraints(0,
                                         ...
                                         0,
                                         0));
    gamePanel.add(new JLabel("Repository:"),
                  new GridBagConstraints(0,
                                         nRowCount,
                                         1,
                                         1,
                                         ...
                                         5,
                                         5));
    gamePanel.add(gameSelector.getRepositoryList(),
    ...
    gamePanel.add(new JLabel("Game:"),
                  new GridBagConstraints(0,
                                         ...
                                         5,
                                         5));
    gamePanel.add(gameSelector.getGameList(),
                  new GridBagConstraints(1,
                                         nRowCount++,
                                         1,
                                         1,
                                         ...
                                         5,
                                         5));
    gamePanel.add(new JLabel("Start Clock:"),
                  new GridBagConstraints(0,
                                         nRowCount,
                                         1,
                                         1,
                                         ...
                                         5,
                                         5));
    gamePanel.add(startClockSpinner,
                  new GridBagConstraints(1,
                                         nRowCount++,
                                         1,
                                         1,
                                         ...
                                         5,
                                         5));
    gamePanel.add(new JLabel("Play Clock:"),
                  new GridBagConstraints(0,
                                         nRowCount,
                                         1,
                                         1,
                                         ...
                                         5,
                                         5));
    gamePanel.add(playClockSpinner,
                  new GridBagConstraints(1,
                                         nRowCount++,
                                         1,
                                         1,
                                         ...
                                         5,
                                         5));
    gamePanel.add(new JLabel("Repetitions:"),
                  new GridBagConstraints(0,
                                         nRowCount,
                                         1,
                                         1,
    ...
    nRowCount = 0;
    playersPanel.add(new JLabelBold("Player List"),
                     new GridBagConstraints(0,
                                            nRowCount++,
                                            3,
                                            1,
    ...
    managerPanel.add(gamePanel,
                     new GridBagConstraints(0,
                                            ...
                                            5,
                                            5));
    managerPanel.add(new JSeparator(),
                     new GridBagConstraints(0,
                                            nRowCount++,
                                            1,
                                            1,
    ...
    scheduler = new Scheduler(matchesTabbedPane,
                              schedulingPanel,
                              leaderboardPanel);
  ...
  class OverviewPanel extends JPanel
  {
    ...
    {
      super(new GridBagLayout());
      add(schedulingPanel, new GridBagConstraints(0,
                                                  0,
                                                  1,
                                                  1,
                                                  2.0,
                                                  ...
                                                  5,
                                                  5));
      add(leaderboardPanel, new GridBagConstraints(1,
                                                   0,
                                                   1,
                                                   1,
                                                   1.0,
  ...
  public void actionPerformed(ActionEvent e)
  {
    if (e.getSource() == gameSelector.getGameList())
    {
      ...
      for (int i = 0; i < roles.size(); i++)
      {
        ...
        gamePanel.add(roleLabels.get(i),
                      new GridBagConstraints(0,
                                             newRowCount,
                                             1,
                                             1,
                                             ...
                                             5,
                                             5));
        gamePanel.add(playerFields.get(i),
                      new GridBagConstraints(1,
                                             newRowCount++,
                                             1,
                                             1,
  ...
  private AbstractAction testPlayerButtonMethod()
  {
    return new AbstractAction("Test")
    {
      ...
      public void actionPerformed(ActionEvent evt)
      {
        ...
        {
          Game testGame = GameRepository.getDefaultRepository()
              .getGame("maze");
          String playerName = playerSelectorList.getSelectedValue().toString();
          List<PlayerPresence> thePlayers = Arrays
              .asList(new PlayerPresence[] {playerSelector
                  .getPlayerPresence(playerName)});
          scheduler.addPendingMatch(new PendingMatch("Test",
                                                     testGame,
                                                     thePlayers,
                                                     -1,
                                                     10,
