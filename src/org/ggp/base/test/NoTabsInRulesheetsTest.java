...
public class NoTabsInRulesheetsTest extends Assert
{
  ...
  public void testNoTabsInRulesheets()
  {
    ...
    for (File gameFile : testGamesFolder.listFiles(new KifFileFilter()))
    {
      ...
      assertFalse("The game " + gameFile +
                      " contains tabs. Run the main method in NoTabsInRulesheetsTest to fix this.",
  ...
  static void overwriteFileWithString(File file, String newContents)
      throws IOException
  {
