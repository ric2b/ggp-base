...
public class PropNetSizeTest extends Assert
{
  ...
  public static Iterable<? extends Object> data()
  {
    ...
    lTests.add(new Object[] {"base", "ticTacToe",      244,   168,   168,    59});
    lTests.add(new Object[] {"base", "connectFour",    765,   619,   619,   301});
    lTests.add(new Object[] {"base", "breakthrough",  1844,  1203,  1203,   144});
    lTests.add(new Object[] {"base", "sudokuGrade1",  5483,  4446,  4399,  1722});
    lTests.add(new Object[] {"base", "checkers",      8079,  4462,  4462,  1571});
    lTests.add(new Object[] {"base", "reversi",      17795,  3997,  3997, 15197});
    ...
    lTests.add(new Object[] {"base", "skirmish",     54143, 39649, 39649,  8899});
    lTests.add(new Object[] {"base", "hex",          81507, 61164, 61164,  3902});
    lTests.add(new Object[] {"base", "hexPie",       83023, 82342, 82335,  3955});
